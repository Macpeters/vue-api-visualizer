...
<div id="app">
  <header>
    ...
    <br />
    <span><a href="https://medium.com/techtrument/handling-ajax-request-in-vue-applications-using-axios-1d26c47fab0">Techtrument Tutorial on Medium</a></span>
  </header>
  <main>
    <h2>Click button to get Random Jokes</h2>
